...
function [q, x, converged_detLimit_OPspaceLimits_check] = calc_qvirt_rad(qa_virt_rad, x0, param)
    [x , ~, converged_detLimit_OPspaceLimits_check]= find_dk_simulink(qa_virt_rad, x0, param.kin_params, param.psi_j, param.beta_j, param.r_fixPlat_j, ...
                                     param.r_mobPlat_j, param.l_all_id, param.l_all, param.r_BasisPla_MobPla, param.max_iter_find_dk_simulink, param.max_radius+0.2, ...
